...
export function humanUltimoResultado(raw: string | null | undefined): string {
  ...
  const map: Record<string, string> = {
    ...
    cap_diario:                   "Tope diario · reintenta mañana",
    cap_semanal:                  "Tope semanal · reintenta en 1 semana",
    ningun_asesor_acepto:         "Reintentando asesores",
    ningun_asesor_contesto:       "Reintentando asesores",
    sin_asesores_presentes:       "Esperando asesores disponibles",
    ofreciendo:                   "Ofreciendo a un asesor",
