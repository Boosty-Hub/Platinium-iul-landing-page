            ...
            <div className={`mt-10 ${t.card} border rounded-2xl p-8 backdrop-blur-xl max-w-6xl mx-auto`}>
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3 shrink-0">
                  ...
                  <a href="tel:+1786XXXXXXX" className="inline-flex items-center justify-center gap-2 bg-gradient-to-br from-[#1d9fa9] to-[#177D85] text-white px-6 py-3 rounded-xl font-bold text-sm no-underline hover:shadow-lg transition-all">
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
                      <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z" />
                    </svg>
                    Llamar ahora
                  </a>
                  {/* TODO: Reemplazar con link real de WhatsApp */}
                  <a href="https://wa.me/1786XXXXXXX" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 border-2 border-[#25D366] text-[#25D366] px-6 py-3 rounded-xl font-bold text-sm no-underline hover:bg-[#25D366]/10 transition-all">
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
        ...
        <Anim>
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3.5">
              ...
              {/* TODO: Reemplazar con número real */}
              <a href="tel:+1786XXXXXXX" className="border-2 border-[#1d9fa9] text-[#1d9fa9] px-8 py-3.5 rounded-lg font-semibold no-underline hover:bg-[#1d9fa9]/10 transition-all inline-flex items-center justify-center gap-2">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
                  <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z" />
                </svg>
                Llámanos ahora
