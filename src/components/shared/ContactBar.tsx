...
export function ContactBar({ t, compact = false }: ContactBarProps) {
  if (compact) {
    return (
      <Anim delay={0.25}>
        <div className={`mt-10 ${t.card} border rounded-2xl p-6 backdrop-blur-xl max-w-6xl mx-auto`}>
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 shrink-0">
              <a href="tel:+16893082809" className="inline-flex items-center justify-center gap-2 bg-gradient-to-br from-[#1d9fa9] to-[#177D85] text-white px-6 py-3 rounded-xl font-bold text-sm no-underline hover:shadow-lg transition-all">
